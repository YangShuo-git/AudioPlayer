...
extern "C" JNIEXPORT jboolean JNICALL Java_com_example_musicplayer_opensles_SoundTrackController_setAudioDataSource(JNIEnv * env, jobject obj, jstring accompany, jfloat percent) {
...
extern "C" JNIEXPORT jint JNICALL Java_com_example_musicplayer_opensles_SoundTrackController_getAccompanySampleRate(JNIEnv * env, jobject obj) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_musicplayer_opensles_SoundTrackController_play
...
extern "C" JNIEXPORT jint JNICALL Java_com_example_musicplayer_opensles_SoundTrackController_getCurrentTimeMills(JNIEnv * env, jobject obj) {
	if (NULL != soundService) {
...
extern "C" JNIEXPORT void JNICALL Java_com_example_musicplayer_opensles_SoundTrackController_stop
(JNIEnv * env, jobject obj) {
	if (NULL != soundService) {
		soundService->stop();
		soundService = NULL;
